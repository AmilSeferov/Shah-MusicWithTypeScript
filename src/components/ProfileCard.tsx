...
function ProfileCard({data}:{data:any}) {
  ...
  return (
    ...
    <div className="w-[150px] sm:w-[170px] md:w-[175px] lg:w-[190px] xl:w-[200px] h-fit flex flex-col items-center mr-[10px] ">
        <div className="w-[100%] flex justify-center "><img className="rounded-full" src={data?.data.visuals.avatarImage?.sources[0].url?data?.data.visuals.avatarImage?.sources[0].url:"https://lh3.googleusercontent.com/a-/ALV-UjVFEZNLRXQNP8iw2vXja-5C1VSaRH59wP2p4-wxrOJlDExqpqMv=w544-h544-l90-rj" }  alt="" /></div>
