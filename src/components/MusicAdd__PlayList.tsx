...
function MusicAdd__PlayList() {
  ...
  return (
    <div className={(sellectedMusic?'flex flex-col' :'hidden') +' h-[440px] w-[360px] md:h-[540px] bg-stone-800 fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 rounded-2xl '}>
